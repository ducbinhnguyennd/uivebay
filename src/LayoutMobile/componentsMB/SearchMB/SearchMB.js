    ...
    <section id="searchform">
      <div className="wrapsearch">
        <div className="rowmb">
          ...
          <div className="col2">
            <div
              ...
              onClick={() => handleCityChange(setDepartureCity, "Chọn điểm khởi hành")}
            >
              {departureCity}
            </div>
        ...
        <div className="paxinfo">
          ...
          <label className="lblsmall lblreset dnone" style={{ display: "none" }}>
            x Bỏ chọn ngày về
          </label>
        </div>
        <div className="rowmb">
        ...
        <div className="rowmb">
          <div className="col13 paxinput">
            <button className="btn btnminus" onClick={() => handleCountChange(setAdultCount, Math.max(adultCount - 1, 0))}>
              -
            </button>
            <select
              className="selectmb"
            ...
            <button className="btn btnplus" onClick={() => handleCountChange(setAdultCount, adultCount + 1)}>
              +
            </button>
          </div>
          <div className="col13 paxinput">
            <button className="btn btnminus" onClick={() => handleCountChange(setChildCount, Math.max(childCount - 1, 0))}>
              -
            </button>
            <select
              className="selectmb"
            ...
            <button className="btn btnplus" onClick={() => handleCountChange(setChildCount, childCount + 1)}>
              +
            </button>
          </div>
          <div className="col13 paxinput">
            <button className="btn btnminus" onClick={() => handleCountChange(setInfantCount, Math.max(infantCount - 1, 0))}>
              -
            </button>
            <select
              className="selectmb"
            ...
            <button className="btn btnplus" onClick={() => handleCountChange(setInfantCount, infantCount + 1)}>
              +
            </button>
          </div>
        </div>
