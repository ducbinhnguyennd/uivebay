    ...
    <div id="main-datve">
      <table id="tbl-passenger">
        <tbody>
          ...
          <tr>
            <td colspan="2" style={{ verticalAlign: "top" }} className="ctr-passenger">
              <table className="passenger-page">
                <tbody>
                  ...
                  <tr>
                      ...
                      <table className="passenger-info">
                        <tbody>
                          <tr>
                            ...
                            <td colspan="2" className="passenger-1" style={{ paddingLeft: "4px", paddingTop: "4px" }}>
                              <input
                                name="ce"
                                type="text"
                                maxlength="100"
                    ...
                    <td className="col-right" style={{ verticalAlign: "top", paddingTop: "2px" }}>
                            ...
                            <td style={{ verticalAlign: "top", paddingTop: "2px" }}>
                              <div className="baggage-container">
                                ...
                                <select
                                  ...
                                  value={baggageOption}
                                  onChange={(e) => setBaggageOption(e.target.value)}
                                >
                                  <option value="0,0" data-baggage-value="0">
                                    Mua thêm ký gửi
                                  </option>
                                  <option value="2,266000" data-baggage-value="20">
                                    Mua 20kg - 266,000 đ
                                  </option>
                                  <option value="4,374000" data-baggage-value="30">
                                    Mua 30kg - 374,000 đ
                                  </option>
                                  <option value="6,482000" data-baggage-value="40">
                                    Mua 40kg - 482,000 đ
                                  </option>
                                  <option value="1,644000" data-baggage-value="50">
                                    Mua 50kg - 644,000 đ
                                  </option>
                                  <option value="3,752000" data-baggage-value="60">
                                    Mua 60kg - 752,000 đ
                                  </option>
                                  <option value="5,860000" data-baggage-value="70">
                                    Mua 70kg - 860,000 đ
                                  </option>
                                </select>
                              </div>
                  ...
                  <tr>
                    <td className="col-left" style={{ paddingTop: "20px", paddingLeft: "4px" }}>
                      <div className="KetquaItem noneMargin_borderTop baggage-info">
                        ...
                        >
                          Giá vé chưa bao gồm hành lý ký gửi.<br />
          ...
          <tr>
            <td colspan="2" style={{ verticalAlign: "top" }} className="ctr-contact">
              <table className="passenger-page contact-page">
                <tbody>
                    ...
                    <td className="col-left">
                      <table className="contact-info">
                        <tbody>
                          ...
                          <tr>
                            <td>
                              Điện thoại <span className="required" style={{ color: "#F00" }}>*</span>
                            </td>
                            <td>
                              <input
                    ...
                    <td className="col-right">
                      <table className="contact-info">
                        <tbody>
                          <tr>
                            <td>
                              <span id="cphMainColumn_ctl00_usrContactInfoD_lblEmail">Email</span>
                            </td>
                          </tr>
                          <tr>
                            <td>
                  ...
                  <tr>
                    <td colspan="2" className="invoice" style={{ paddingTop: "10px" }}>
                      <input
                        ...
                        <table>
                          <tbody>
                            <tr id="invoice_details" className="contact-input">
                              <td>
                                <table style={{ width: "100%", border: "1px solid #d7d7d7", padding: "5px" }}>
                                  <tbody>
                                    <tr>
                                      <td colspan="2">
                                    ...
                                    <tr><td colspan="2"><p style={{color:"#D51317", clear:"both", lineHeight: "1.4"}}>Lưu ý về việc xuất hóa đơn: <br/> Thông tin hóa đơn gửi tại đây hoặc có thể bổ sung sau, nhưng cần được gửi trong vòng 24 giờ từ thời điểm thanh toán. Abay sẽ xuất HĐ điện tử trong ngày nhận được thanh toán. Quý khách vui lòng quay lại web Abay.vn, vào tiện ích "Xem lại đơn hàng" để lấy Hóa Đơn.</p></td></tr>
                                  </tbody>
                                </table>
                              </td>
                            </tr>
                  ...
                  <tr>
                    <td colspan="2" className="remark" style={{ paddingTop: "10px" }}>
                      <input
                      ...
                      />
                      <label for="cphMainColumn_ctl00_usrContactInfoD_chkRemarkAll">Ghi chú về đơn hàng</label>
                    </td>
                  </tr>
                  {isRemarkChecked && (
                    <tr>
                      ...
                      <div className="tblotherflight">
                        ...
                        <table className="w70p tblcurrentflight">
                          <tbody>
                            <tr>
                              <td>
                                <img src="/_WEB/_File/Images/AirlineLogo/smVJ.gif" alt="" className="img-VJ-Full h30" />
                              </td>
                              ...
                              <td className="nowrap">
                                <span className="bold">&nbsp;&nbsp;SGN&nbsp;05:00</span>
                                <span>&nbsp;-&nbsp;</span>
                                <span>HAN&nbsp;07:10</span>
                              </td>
                            </tr>
                  ...
                  <tr>
                    <td colspan="2" style={{ padding: "10px 0 10px 2px" }}>
                      ...
                      <a
                        href="/Ve-May-Bay-Gia-Re-TP_Ho_Chi_Minh-Ha_Noi-5Thang1"
                  ...
                  <tr>
                    <td colspan="2">
                      ...
                      >
                        <p>Bước tiếp theo:</p>
                        <p>- Vé điện tử sẽ được gửi vào điện thoại, email ngay sau khi quý khách thanh toán</p>
                        <p>- Thanh toán bằng mã QR, chuyển khoản, hoặc thẻ nội địa/quốc tế, ví điện tử, payoo,...</p>
                        <p>- Nếu quý khách cần liên hệ, vui lòng gọi 19006091. Tổng đài Abay phục vụ 24/7 (không nghỉ)</p>
                      </div>
                    </td>
                  </tr>
                  <tr>
                    ...
                    <td colspan="2">
                      <div className="lydo">
                        ...
                        <ul style={{ listStyle: "inside" }}>
                          ...
                          <li>Công ty vé máy bay online đầu tiên, 10 năm kinh nghiệm</li>
                        </ul>
                      </div>
                    </td>
                  </tr>
