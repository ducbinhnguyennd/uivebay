    ...
    <div>
      ...
      <div className="thanhtoan">
        <div className="order-details">
          <h3>Đơn hàng: 5004690</h3>
          <p>Tình trạng: đợi thanh toán</p>
          <div className="support-options">
            <label>
              <img src="./phone2.png" style={{ marginRight: "5px" }} /> Nếu quý
              khách cần Abay gọi tư vấn thêm?
              <br />
          ...
          <div>
            ...
            <div className="bank-details">
              <div className="bank-info">
                ...
                <p>
                  Số tiền: <strong style={{ color: "red" }}>1,844,000</strong>{" "}
                  <button>Copy</button>
                </p>
                <p>
        ...
        <div className="flight-details">
          <div>
            ...
            <div style={{ display: "flex" }}>
              <img src="./smVN.gif" /> <p>VN7226</p>
            </div>
            <p>Anh: NGUYEN NAM</p>

            <p>Hành lý: 10kg xách tay + 1 kiện 23kg ký gửi</p>
          </div>
          <div>
            T.Hai 06/01 <br /> 23:50 - 01:55
          </div>
        </div>
      </div>
      <div className="faq-hdtt">
        <Accordion title="Hướng dẫn upload chứng từ">
          <p>
            Trong trường hợp việc cập nhật tình trạng thanh toán có thể bị trễ,
            Quý khách vui lòng sử dụng tiện ích này để xác nhận việc đã thanh
            toán cho Abay.
          </p>
        </Accordion>
